...
/* ─────────────────────────────────────────────
   ...
   On success → /onboarding (new users always go
   through onboarding before /home).
───────────────────────────────────────────── */
...
export default function SignUpPage() {
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      // Supabase handles redirect back; onboarding guard handles routing
    } catch (err: unknown) {
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading || googleLoading || !pwValid}
            ...
            onMouseEnter={e => { if (!loading && !googleLoading && pwValid) e.currentTarget.style.background = "var(--forest-m)"; }}
